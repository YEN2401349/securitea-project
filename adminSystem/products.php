    ...
    <section>
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-2">
                ...
                <button id="addCustomBtn" class="bg-green">プラン一追加</button>
            </div>
        </div>
    ...
    <section>
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-2">
                ...
                <button id="addPackageBtn" class="bg-green">オプション一追加</button>
            </div>
        </div>
...
<script src="component/script/coustomModel.js"></script>
