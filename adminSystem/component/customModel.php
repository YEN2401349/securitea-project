<div id="customModel" class="customModelHidden">
    <div>
            ...
            <form id="customForm">
                <div class="formContainer">
                    ...
                    <div style="flex:1 1 45%;">
                        ...
                        <textarea name="custom_eye_catch" cols="70" rows="3" maxlength="255"></textarea>
                    </div>
                    <div style="flex:1 1 45%;">
                        <label>機能</label><br>
                        <textarea name="custom_security_features" cols="70" rows="10" maxlength="255"></textarea>
                    </div>
                    <div style="flex:1 1 45%;">
                        <label>説明</label><br>
        ...
        <div style="margin-top:1rem; text-align:right;" class="modalFooter">
            ...
            <button type="submit" class="bg-blue" form="customForm">保存</button>
        </div>
    </div>
</div>