...
Q パフォーマンス最適化とは何ですか？
A キュリティソフトによって動作が重くならないように、機能維持しつつ軽量化を行う機能です
...
Q どうやって商品を買うの？
A メニューやアカウント情報ページから商品一覧ページに飛びそこから商品を選択できお支払いをすることで商品を購入することができます。

Q 支払い方法は何ですか？
A クレジットカード、PayPal、銀行引き落としの 3 つから選べ、更新日に自動的に引き落とされます

Q ライトプランについて
A 基本的な機能だけが含まれているプランでお値段も安く気軽に試しやすいプランです。

Q スタンダードプランについて
A ライトプランより充実させたプランで値段もちょうどいいので迷ったらこのプランをおすすめします。

Q エキスパートプランについて
A スタンダードプランよりさらに充実させたプランでデバイスをしっかり管理したい人向けでパフォーマンスの最適化も行っているので動作が重くなりにくいです

Q プレミアムプランについて
A 法人や専門家向けで最大50台まで利用できますがその分料金は月1500円からとなっています

Q 通常版とクラウドバックアップ増量版の違いは
A クラウドバックアップのデータ量だけが違います。
  その他は変わりません。

Q 購入したプランはどうやって利用するの?
A アカウント情報ページからダウンロードできます。

Q 検索機能について
A 検索結果は機能名とプラン名の部分一致で表示されます。

Q プランを切り替えるとき支払いはどうなるの？
A "即時切替なら契約期間はそのままで差額分支払う必要があり、
自動更新日に切替なら現在利用しているプランが終わればプランが切替わった後に料金が発生します"

Q プラン変更時に「自動更新日に切替（予約）」を選択したらどうなるの？
A 現在のプラン終了後に、予約したプランが開始されます。

Q プラン変更時に「今すぐ適用（期間引継ぎ）」を選択したらどうなるの？
A 現在のプランの残り日数を引継ぎ、新しいプランを開始します。
料金は現在のプランとの差額になります。

Q プラン変更時に「今すぐ適用（期間リセット）」を選択したらどうなるの？
A 現在のプランを終了し、一から新しい契約としてプランを開始します。
